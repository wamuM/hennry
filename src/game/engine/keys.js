//? This file has the function that sets up all the mouse/keyboard related stuff
 ...
 */
function setUpKeyEvents(clickContext){
    clickContext.addEventListener("mousemove",(e)=>{
        window.clientX = e.offsetX
        window.clientY = e.offsetY
    })
